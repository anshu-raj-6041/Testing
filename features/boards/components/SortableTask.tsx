...
export function SortableTask({ task, onDeleteTask }: SortableTaskProps) {
  ...
  return (
    <div ref={setNodeRef} style={styles} {...attributes} {...listeners}>
      <Card className="cursor-pointer hover:shadow-md hover:shadow-orange-500/10 transition-all border-gray-800 bg-gray-800/50 backdrop-blur-sm hover:border-orange-500/50">
        <CardContent className="p-3 sm:p-4">
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div
                className="p-1.5 hover:bg-gray-700/50 rounded-md group"
